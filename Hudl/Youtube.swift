...
///// THIS CLASS HAS BEEN DOWNLOADED AND EDITED TO BE SWIFT 3 COMPATIBLE
//// THE CODE IS NOT MINE AND I ONLY MODIFIED FEW THINGS TO MAKE IT WORK
//// I DONT TAKE ANY CREDIT OF THIS CLASS. 
...
open class Youtube: NSObject {
  ...
  */
  open static func h264videosWithYoutubeID(_ youtubeID: String) -> [String: AnyObject]? {
    ...
    dataTask = session.dataTask(with: request as URLRequest) { (data, response, _) -> Void in
